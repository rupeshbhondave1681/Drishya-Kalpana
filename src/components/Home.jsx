...
//                   <img src="/Rupesh.jpg" alt="Rupesh Bhondave" />
//                 </div>
//               </div>
...
export default function Home({ language, scrollToSection }) {
  const content = {
    en: {
      ...
      title: "Full Stack Software Developer",
      description:
        "I’m a Full Stack Developer focused on building scalable web and enterprise applications. Skilled in Java, Spring Boot, React JS, Angular, and REST APIs. I’ve contributed to BFSI solutions with clean architecture, secure integrations, and agile collaboration.",
      getInTouch: "Get In Touch",
      downloadResume: "Download Resume",
    },
    hi: {
      ...
      title: "फुल स्टैक सॉफ्टवेयर डेवलपर",
      description:
        "मैं एक फुल स्टैक डेवलपर हूं, जिसके पास Java, Spring Boot, React JS, Angular और REST API के साथ 2+ वर्षों का अनुभव है। मैंने ई-केवाईसी और लोन मैनेजमेंट जैसे प्लेटफॉर्म पर काम किया है, जिसमें सुरक्षित इंटीग्रेशन और कुशल विकास शामिल हैं।",
      getInTouch: "संपर्क करें",
      downloadResume: "रिज्यूमे डाउनलोड करें",
    },
    mr: {
      ...
      title: "फुल स्टॅक सॉफ्टवेअर डेव्हलपर",
      description:
        "मी फुल स्टॅक डेव्हलपर असून, Java, Spring Boot, React JS, Angular आणि REST API मध्ये 2+ वर्षांचा अनुभव आहे. मी ई-केवायसी व लोन मॅनेजमेंट सिस्टीम्सवर काम केले असून, सुरक्षित आणि कार्यक्षम सोल्यूशन्स देण्यावर भर दिला आहे.",
      getInTouch: "संपर्क साधा",
      downloadResume: "रिझ्युमे डाउनलोड करा",
    },
  };
  ...
  return (
    <section id="Home" className="home-section">
      {/* SEO Metadata */}
      <Helmet>
        <title>{content[language].name} | {content[language].title}</title>
        <meta name="description" content={content[language].description} />
        <meta property="og:title" content={content[language].name} />
